...
#
# The directory lists this plugin as "Ops Kit for WordPress" with the slug
# ops-kit-for-wordpress (new wordpress.org slugs may not start with "wp"), while
